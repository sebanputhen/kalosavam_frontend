  ...
  const getStepContent = (step) => {
    ...
    if (step === 1) {
      ...
      return (
        ...
        <Alert severity="info" sx={{ mb: 2 }}>Max 3 events: up to 2 individual + 1 group OR 1 individual + 2 group for <strong>{sec}</strong> ({SECTION_CONFIG[sec].label})</Alert>
                ...
                <Table>
                  ...
                  <TableBody>
                    {filteredParticipants.map((p, i) => {
                      ...
                      const canAdd = (ec.single + ec.group) < 3 && ec.single < 2 || ec.group < 2;
